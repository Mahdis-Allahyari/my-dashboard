                ...
                <div className="space-y-4">
                        ...
                        <div key={item.id}
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-600 translation-colors font-bold">
                                    -
                                </button>
                 ...
                 text-gray-800 dark:text-gray-100">
                    ...
                    <div className="bg-white dark:bg-gray-800  rounded-xl border border-gray-200 dark:border-gray-700 p-6" >
                        ...
                        <button className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold translation-colors">
                            Checkout
                        </button>
                    </div>
                </div>
